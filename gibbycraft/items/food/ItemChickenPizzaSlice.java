...
public class ItemChickenPizzaSlice extends ItemFood
{
	 ...
	 */
	public ItemChickenPizzaSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ChickenPizzaSlice.png";
	}
}
