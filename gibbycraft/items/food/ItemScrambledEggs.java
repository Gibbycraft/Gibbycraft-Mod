...
public class ItemScrambledEggs extends ItemFood
{
	 ...
	 */
	public ItemScrambledEggs(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ScrambledEggs.png";
	}
}
