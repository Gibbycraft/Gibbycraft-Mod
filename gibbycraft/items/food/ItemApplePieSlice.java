...
public class ItemApplePieSliceSlice extends ItemFood
{
	 ...
	 */
	public ItemApplePieSliceSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ApplePieSliceSlice.png";
	}
}
