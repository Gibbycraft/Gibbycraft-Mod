...
public class ItemCheesePotatoChips extends ItemFood
{
	 ...
	 */
	public ItemCheesePotatoChips(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/CheesePotatoChips.png";
	}
}
