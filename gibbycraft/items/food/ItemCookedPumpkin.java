...
public class ItemCookedPumpkin extends ItemFood
{
	 ...
	 */
	public ItemCookedPumpkin(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/CookedPumpkin.png";
	}
}
