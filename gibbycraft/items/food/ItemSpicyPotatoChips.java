...
public class ItemSpicyPotatoChips extends ItemFood
{
	 ...
	 */
	public ItemSpicyPotatoChips(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/SpicyPotatoChips.png";
	}
}
