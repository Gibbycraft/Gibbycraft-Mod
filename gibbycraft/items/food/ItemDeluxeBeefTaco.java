...
public class ItemDeluxeBeefTaco extends ItemFood
{
	 ...
	 */
	public ItemDeluxeBeefTaco(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/DeluxeBeefTaco.png";
	}
}
