...
public class ItemPumpkinCookie extends ItemFood
{
	 ...
	 */
	public ItemPumpkinCookie(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/PumpkinCookie.png";
	}
}
