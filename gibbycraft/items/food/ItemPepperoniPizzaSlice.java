...
public class ItemPepperoniPizzaSlice extends ItemFood
{
	 ...
	 */
	public ItemPepperoniPizzaSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/PepperoniPizzaSlice.png";
	}
}
