/**
 * @author Gibby. Edited for use from base food by YoshiFan501
 */
...
public class ItemBeefPizzaSlice extends ItemFood
{
	 ...
	 */
	public ItemBeefPizzaSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/BeefPizzaSlice.png";
	}
}
