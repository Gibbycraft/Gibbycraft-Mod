...
public class ItemDoubleChocolateCookie extends ItemFood
{
	 ...
	 */
	public ItemDoubleChocolateCookie(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/DoubleChocolateCookie.png";
	}
}
