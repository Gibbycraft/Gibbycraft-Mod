...
public class ItemCheesePizzaSlice extends ItemFood
{
	 ...
	 */
	public ItemCheesePizzaSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/CheesePizzaSlice.png";
	}
}
