...
public class ItemDeluxeBeefBurrito extends ItemFood
{
	 ...
	 */
	public ItemDeluxeBeefBurrito(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/DeluxeBeefBurrito.png";
	}
}
