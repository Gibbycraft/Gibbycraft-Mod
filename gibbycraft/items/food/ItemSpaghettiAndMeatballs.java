...
public class ItemSpaghettiAndMeatballs extends ItemFood
{
	 ...
	 */
	public ItemSpaghettiAndMeatballs(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/SpaghettiAndMeatballs.png";
	}
}
