...
public class ItemPepperoniPizza extends ItemFood
{
	 ...
	 */
	public ItemPepperoniPizza(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/PepperoniPizza.png";
	}
}
