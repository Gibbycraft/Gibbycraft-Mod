...
public class ItemChickenSandwich extends ItemFood
{
	 ...
	 */
	public ItemChickenSandwich(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ChickenSandwich.png";
	}
}
