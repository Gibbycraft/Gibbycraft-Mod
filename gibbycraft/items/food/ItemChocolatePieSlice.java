...
public class ItemChocolatePieSlice extends ItemFood
{
	 ...
	 */
	public ItemChocolatePieSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ChocolatePieSlice.png";
	}
}
