...
public class ItemBarbequeChicken extends ItemFood
{
	 ...
	 */
	public ItemBarbequeChicken(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/BarbequeChicken.png";
	}
}
