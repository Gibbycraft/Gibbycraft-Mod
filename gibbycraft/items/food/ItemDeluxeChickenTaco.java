...
public class ItemDeluxeChickenTaco extends ItemFood
{
	 ...
	 */
	public ItemDeluxeChickenTaco(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/DeluxeChickenTaco.png";
	}
}
