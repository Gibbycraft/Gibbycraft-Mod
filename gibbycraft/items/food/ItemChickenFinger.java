...
public class ItemChickenFinger extends ItemFood
{
	 ...
	 */
	public ItemChickenFinger(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ChickenFinger.png";
	}
}
