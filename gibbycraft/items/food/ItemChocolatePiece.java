...
public class ItemChocolatePiece extends ItemFood
{
	 ...
	 */
	public ItemChocolatePiece(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/ChocolatePiece.png";
	}
}
