...
public class ItemPumpkinPieSlice extends ItemFood
{
	 ...
	 */
	public ItemPumpkinPieSlice(int par1, int par2, float par3, boolean par4) 
	{
	...
	{
		return "/gibbycraft/gui/PumpkinPieSlice.png";
	}
}
